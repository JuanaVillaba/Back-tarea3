    ...
    return new Promise((resuelve, reject) => {
        setTimeout(() => {
            ...
            productos[encontrado].stock > 0 ?
                resuelve(encontrado) :
                reject("Promesa rechazada por stock insuficiente".bgRed);
...
const mercadoRestringido = () => {
    ...
    return validarStock(productoAbuscar, productos, encontrado)
        .then((encontrado) => {
            ...
            console.log("Fin de la compra".yellow)
        })
}
module.exports = { mercadoRestringido };